define(['jasmine'], function(jasmine) {
    ...
    XUnitConsoleReporter.prototype = {
        ...
        reportRunnerResults: function(runner) {
            ...
            // When all done, make it known on XUnitConsoleReporter
            XUnitConsoleReporter.finished_at = (new Date()).getTime();
        },
    ...
    // export public
    jasmine.XUnitConsoleReporter = XUnitConsoleReporter;
