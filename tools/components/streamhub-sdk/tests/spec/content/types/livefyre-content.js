...
function ($, jasmine, LivefyreContent) {
    describe('A LivefyreContent object', function () {
        ...
        it ("should recognize livefyre content from bootstrap", function () {
            var content = new LivefyreContent(mockData.livefyreBootstrapContent);
            expect(content instanceof LivefyreContent).toBe(true);
        });
        
        it ("should recognize livefyre content from stream", function () {
            var content = new LivefyreContent(mockData.livefyreStreamContent);
            expect(content instanceof LivefyreContent).toBe(true);
        });
    });
});
